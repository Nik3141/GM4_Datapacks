...
#-----error correction so for example a little right and mostly up will be registered as up and not upRight or right-----
...
#check for completed spells and tag player with gm4_spell_completed if the player has not been moving long enough
execute if score @s gm4_timer = timerTime gm4_parameter run function #wandistry:check_spells
execute if score @s gm4_timer = timerTime gm4_parameter run tag @s add gm4_spell_confirmed


#-----confirm and record inputs-----
